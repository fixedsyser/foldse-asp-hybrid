...
def student_depression():
    """
    The Student Depression dataset contains over 27k instances each with 18 attributes representing
    the lives of students that could effect their state of depression. The label is depression: Binary (1/0).
    The attributes are:
    ...
    * sleep_duration: Average daily sleep duration.
    * work_pressure: Amount of perceived work pressure on a scale from 1 to 5
    * academic_pressure: Amount of perceived acadamic pressure on a scale from 1 to 5
    * study_satisfaction: On a scale from 1 to 5
    * job_satisfaction: On a scale from 1 to 5
    * dietary_habits: Categorical attribute: Healthy/Unhealthy/Moderate/Others
    * degree: The academic degree
    * have_you_ever_had_suicidal_thoughts : Binary category (Yes/No) 
    * work_study_hours: amount of hours working and studying per day.
    * financial_stress: On a scale from 1 to 5
    * family_history_of_mental_illness: Binary (Yes/No)    
